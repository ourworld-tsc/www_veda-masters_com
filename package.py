...
class Package(j.baseclasses.threebot_package):
    ...
    kosmos -p "j.tools.threebot_packages.get('veda_masters_master',giturl='https://github.com/veda-websites/www_veda-masters_com',branch='production')"
    ...
    def prepare(self):
        ...
        server.configure()
        website = server.websites.get("veda_masters")
        website.ssl = False
        website.port = 80
        locations = website.locations.get("veda_masters")
